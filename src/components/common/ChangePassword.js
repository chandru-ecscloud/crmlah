                ...
                <div className="form-group mt-3">
                  ...
                  <div className="input-group">
                    <input type={showOldPassword ? "text" : "password"}
                      className={`form-size form-control  ${formik.touched.oldPassword && formik.errors.oldPassword ? 'is-invalid' : ''}`}
                ...
                <div className="form-group mt-3">
                  ...
                  <div className="input-group">
                    <input type={showNewPassword ? "text" : "password"}
                      className={`form-size form-control  ${formik.touched.newPassword && formik.errors.newPassword ? 'is-invalid' : ''}`}
                ...
                <div className="form-group mt-3">
                  ...
                  <div className="input-group">
                    <input
                      ...
                      className={`form-size form-control  ${formik.touched.confirmPassword && formik.errors.confirmPassword ? 'is-invalid' : ''}`}
