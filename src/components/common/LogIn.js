                ...
                <div className='row py-5'>
                    ...
                    <div className='col-lg-6 col-md-6 col-12'>
                        ...
                        <form>
                            ...
                            <button className="contactsubmitBtn btn btn-danger mt-3" type="button">Login</button>
                            <p className='forgotWord text-center mt-5'>
                                Forgot <Link to='/forgot' className='password-link'>Password</Link>?
                            </p>
                            <p className='forgotWord text-center'>Don't have an accounts? <Link to='/signin' className='password-link'>Sign up</Link></p>
                        </form>
                    </div>
                </div>
            </div>
