...
function CalenderShow({ id, showViewModal, setShowViewModal }) {
    //   const { id } = useParams();
    ...
    useEffect(() => {
        if (id) { // Add a condition to check if id is defined
            console.log("id", id);
            userData();
        }
    }, [id, showViewModal]);
            ...
            <Modal.Body className="custom-modal-body">
                <section className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-md-6 col-12 my-2">
                            <div className="row">
                                <div className="col-6"><b>Service Name</b></div>
                        ...
                        <div className="col-md-6 col-12 my-2">
                            <div className="row">
                                ...
                                <div className="col-6">: {clientData.member
                                }</div>
                            </div>
                        </div>
                        <div className="col-md-6 col-12 my-2">
                        ...
                        <div className="col-md-6 col-12 my-2">
                            <div className="row">
                                <div className="col-6"><b>zipCode</b></div>
